...
class Parser:
    ...
    def free_identifier(
            self, lineno: t.Optional[int] = None) -> nodes.InternalName:
    ...
    def parse_for(self) -> nodes.For:
        ...
        return nodes.For(target, iter, body, else_,
                         test, recursive, lineno=lineno)
    ...
    def parse_call(self, node: nodes.Expr) -> nodes.Call:
        ...
        return nodes.Call(node, args, kwargs, dyn_args,
